...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/category/laptop/`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/category/desktop/`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/category/monitor/`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/category/ink-toner/`, lastModified, changeFrequency: "weekly", priority: 0.8 },
